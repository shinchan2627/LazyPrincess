...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/tamcinemasdubt'),
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love Master Roshi♥️')
            else:
        ...
        if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
            ...
            btn =  [[InlineKeyboardButton('⚡ Rq-group ', url="https://t.me/tamcinegrp"),
                                                    InlineKeyboardButton('Channel 🤖',url='https://t.me/tamcinemas') ],
                                 [InlineKeyboardButton(' Report ⚡', url="https://t.me/Tamcine_abot"), 
    ...
    if query.data.startswith("file"):
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT BUG 🐞", url=f"https://telegram.me/{SUPPORT_CHAT}")
            ],[
                InlineKeyboardButton(text=f"⚡️ 𝙏𝙖𝙢𝙞𝙡 𝘾𝙞𝙣𝙚𝙢𝙖𝙨 𝙃𝘿 🦋", url=f'https://t.me/tamcinemas')
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/tamcinemasdubt'),
        ] 
    )
